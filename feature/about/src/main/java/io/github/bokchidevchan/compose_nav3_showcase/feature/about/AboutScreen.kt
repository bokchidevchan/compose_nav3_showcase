package io.github.bokchidevchan.compose_nav3_showcase.feature.about
...
fun AboutScreen(
    ...
    appInfo: AppVersionInfo = AppVersionInfo()
) {
    ...
    Scaffold(
        ...
        LazyColumn(
            ...
            item {
                SettingsItem(
                    title = "Version",
                    subtitle = "${appInfo.versionName} (${appInfo.versionCode})",
